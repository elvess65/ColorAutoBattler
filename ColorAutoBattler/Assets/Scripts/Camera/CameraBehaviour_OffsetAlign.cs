...
{
    /// <summary>
    /// Поведение камеры - выравнивание к указанному отступу
    /// </summary>
    public class CameraBehaviour_OffsetAlign : MonoBehaviour
    {
        ...
        private InterpolationData<Vector3> m_PositionLerpData;
        private InterpolationData<Quaternion> m_RotationLerpData;

        void Awake()
        {
            m_PositionLerpData = new InterpolationData<Vector3>(AnimationTime);
