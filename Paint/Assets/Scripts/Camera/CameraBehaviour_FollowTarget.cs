...
namespace Paint.CameraSystem
{
    ...
    public class CameraBehaviour_FollowTarget : MonoBehaviour
    {
        ...
        public bool IsMoving => Vector3.Distance(transform.position, m_TargetPos) > m_STOP_DISATNCE; 


        void Awake() => m_Offset = Vector3.zero;
        ...
        /// </summary>
        public void PauseFollowing() => m_IsActive = false;
